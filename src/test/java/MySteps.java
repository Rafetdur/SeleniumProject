...
public class MySteps extends BasePage {
    ...
    public void tearDown(Scenario scenario) {
        if (scenario.isFailed()) {
            ...
            String link ="C:\\Users\\rafet\\Downloads\\Selenium training template\\WebFunctions\\target\\cucumber-html-report\\index.html";
    ...
    @After (order=2)
    public void after2Scenario() {
        System.out.println("*************after2 Scenario***********");
    }
